...
* Add #__lang__# attribute to xref:char:index.adoc[character] types xref:char:features/tl.adoc[tl] and xref:char:features/wl.adoc[wl]
* Add character type xref:char:features/ta.adoc[ta] (https://github.com/usfm-bible/tcdocs/blob/main/proposals/2024/U24002%20Textual%20Alternatives.md[U24002])
...
* Add xref:ms:vid.adoc[vid] milestone to specify current reference (https://github.com/usfm-bible/tcdocs/blob/main/proposals/2025/U25008%20vid.md[U25008])
