...
* An optional `list` element in USX, and two pairs of xref:ms:index.adoc[milestones] in USFM to represent the start and end of a list or table (TC proposal: https://github.com/usfm-bible/tcdocs/blob/main/proposals/2025/U25003%20Lists%20and%20Tables.md[U25003^]).
