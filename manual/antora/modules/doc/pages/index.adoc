...
* An optional collection of at least one of xref:cv:c.adoc[chapter], xref:para:titles-sections/index.adoc[section], xref:para:index.adoc[paragraph/poetry], xref:para:lists/index.adoc[list], xref:para:tables/index.adoc[table], or xref:sbar:index.adoc[sidebar] elements for the main content of a scripture book.
