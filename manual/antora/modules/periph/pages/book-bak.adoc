...
The `BAK` xref:para:identification/books.adoc[book] and its divisions can be used for adding content which is normally presented at the end of a scripture publication.
