<schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt1"
    ...
    <pattern>
        <rule context="ms[@style='qt-s']">
            ...
            <assert test="not(following::ms[py:test(@style, 'qt[1-5]-s')])">qt-s should not be mixed with numbered qt styles</assert>
    ...
    <pattern>
        <rule context="ms[py:test(@style, 'qt[1-5]\-s')]">
            <let name="nextQt" value="following::ms[py:test(@style, 'qt[1-5]\-[se]')][1]" />
