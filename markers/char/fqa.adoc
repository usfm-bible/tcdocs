...
Description:: xref:note:footnote/f.adoc[Footnote] - Alternate translation. Used to distinguish between a quotation of the current scripture translation (marked with xref:char:notes/footnote/fq.adoc[fq]) and an alternate translation.
Syntax::
* *USFM:* `+\fqa_{content}+`
