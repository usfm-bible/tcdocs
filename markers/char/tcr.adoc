...
Description:: Table cell - right aligned.
* The variable `#` represents the table column number (required).
[NOTE]
.Syntax notes
====
...
+
.Numbers 2.3-9 (GNT)
[source#src-usfm-char-tcr_1,usfm,highlight=7..10]
----
\id NUM
\c 2
\p
...
+
.Numbers 2.3-9 (GNT)
[source#src-usx-char-tcr_1,xml,highlight=17;22;27;30;31]
----
<usx version="3.2">
...
+
.Numbers 2.3-9 (GNT)
[source#src-usj-char-tcr_1,json,highlight=]
----
{
  "type": "USJ",
  "version": "3.1",
