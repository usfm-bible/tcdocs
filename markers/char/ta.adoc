...
#a-<identifier>#::: One or more attributes for providing text alternatives. Each attribute should be begin with `a-`
...
\c 13
\p ...
\v 23 Can people change the \ta color|a-uk="colour"\ta* of their skin, or a 
...
<usx version="3.1">
  ...
  <para style="p">
    ...
    learn to do what is right.<verse eid="JER 13:23" /></para>
</usx>
----
USJ::
+
...
image::char/ta_1.jpg[Jeremiah 13.23 (GNT),300]
