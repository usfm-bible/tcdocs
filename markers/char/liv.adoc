...
[source#src-usfm-char-lik_1,usfm,highlight=7..19]
----
\id 1CH
\c 27
...
<usx version="3.2">
  ...
  <list>
    ...
    <para style="lf" vid="1CH 27:16-22">This was the list of the administrators 
      of the tribes of Israel.<verse eid="1CH 27:16-22"/></para>
  </list>
</usx>
----
USJ::
