...
<para style="p">
  <verse number="14" style="v" pubnumber="1b" sid="XXA 1:14"/> This is a copy of
  the letter:</para>
<para style="pmo" vid="XXA 1:14">From Artaxerxes, the Great King, to the governors
  and officials of my one hundred twenty-seven provinces from India to Ethiopia.
  <verse eid="XXA 1:14"/></para>
<para style="pm">
  <verse number="15" style="v" pubnumber="2b" sid="XXA 1:15"/> I rule many
