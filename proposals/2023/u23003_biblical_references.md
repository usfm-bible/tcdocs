...
This document defines a normative, serialization-independent scheme for scripture references independent of language.
...
- to reference any textual content within a scripture file, including non-scriptural material such as notes and headings
  (excluding whitepsace and syntactic markup characters, such as  <> around an element tag in USX or a backslash \\ in USFM, which are not part of the underlying data model)
...
- to reference specifically identified elements such as tables and marked paragraphs via identifiers.
